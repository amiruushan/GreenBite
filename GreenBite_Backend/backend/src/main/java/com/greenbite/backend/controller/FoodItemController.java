...
//    }
    ...
    @PostMapping("/purchase/{foodItemId}/{quantity}")
    public FoodItemDTO purchaseFoodItem(@PathVariable Long foodItemId, @PathVariable int quantity) {
        System.out.println("HI");
        return foodItemService.purchaseFoodItem(foodItemId, quantity);
    }
